...
import './screen.css';
import { BookFilled,HeatMapOutlined } from '@ant-design/icons';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:"#090113" ,color:"#895BC8" ,height: "150px" }}>
            <div className="headertext">
              <label><HeatMapOutlined  style={{color:"#e89a3c" ,fontSize:"50px", marginRight:"20px"}} />NUMERICAL METHOD</label>
            </div>
          </Header>
          <Layout>
          <Sider width={335} style={{ background: "#fff" }}>
              <Menu
                mode="inline"
                style={{ height: '90vh', borderRight: 0, backgroundColor: "#DF6DDA", overflowY: "scroll" }}
                theme="light"
              >
          ...
          <Footer style={{ backgroundColor: "purple", minHeight: 120 }}>
            <p style={{ fontSize: "20px", fontWeight: "bold", color: "white" }}>
              © All Right Reserved<br />

              <p style={{fontSize:"22px"}}><BookFilled style={{ fontSize: "30px" }} /><a  rel="noopener noreferrer"  style={{ color: "white", textDecoration: "none" }}> Chayanin supavanith 6204062660030</a></p>
